...
namespace App\Route\Prefix\Movies;
...
class Schedule implements MatchInterface, BuildInterface
{
    ...
    {
        $action = $router->resolveActionWithIntegerParam($routePath, $request, 'showtime_id', 'view');
        return array('controller' => '\App\ControllerPublic\MovieSchedule', 'action' => $action);
    }
